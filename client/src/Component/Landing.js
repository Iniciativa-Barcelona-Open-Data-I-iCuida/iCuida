            ...
            <div className="container-fluid mt-3"> 
                ...
                <div className="row">  
                    <div className="col-lg-4"> 
                        ...
                        {/*<img src="/img/tramites-legales" alt="tramites-legales" className="img-thumbnail rounded-lg float-center"></img>*/}
                ...
                <div className="row">  
                    <div className="col-lg-4"> 
                        ...
                        {/*<img src="/img/seguridad-social" alt="seguridad-social" className="img-thumbnail rounded-lg float-center"></img>*/}
                ...
                <div className="row">  
                    <div className="col-lg-4"> 
                        ...
                        {/*<img src="/img" alt="extranjería" className="img-thumbnail rounded-lg float-center"></img>*/}
